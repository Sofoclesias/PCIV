        ...
        try:
            ...
            Selecciona tu opción: '''))
                        ...
                        if op2 == 1:
                            ...
                            for i in range(len(zas)):
                                print(
                                    "{0:<5s}{1:<20s}{2:>20s}{3:>20d}".format(str(zas[i][0]), zas[i][1], str(zas[i][2]),
                                                                             zas[i][3]))
                        elif op2 == 2:
                            while True:
                                try:
            ...
            Selecciona tu opción: '''))
                            ...
                            if op2 == 1:
                                ...
                                print(
                                    "{0:<20s}{1:<20s}{2:<20s}{3:<20s}{4:>20s}{5:>20s}".format("DNI", "Nombres",
                                                                                              "Apellidos",
                                                                                              "Usuario",
                                                                                              "Número de pedidos",
                                                                                              "Puntos de referidos"))
                        ...
                        while usuFlag:
                            usux = input(
                                "Ingrese el nombre del usuario que deseas eliminar (para cancelar,escribir n): ")
                            if usux == "n":
                                usuFlag = False
                                break
                            if usux != "n":
